<template>
  <div class="goods">
    ...
    <div class="subheader">
      ...
      <div class="sh1">
        <span class="sh11">Home & Furniture</span>
        ...
        <div class="smenu1">
          ...
          <div class="sm3">
            ...
            <div class="sm32">
              ...
              <div class="sm34">
                <span class="sm35" @click="selectCategory('furniture')">Furniture</span>
                <span class="sm35" @click="selectCategory('home-decoration')"
                  >Home-decoration</span
                >
                <span class="sm35" @click="selectCategory('lighting')">lighting</span>
              </div>
            </div>
          </div>
        </div>
  ...
  computed: {
    ...
    filteredProducts() {
      return this.products.filter((product) => {
        ...
        const isFurniture = category.includes("furniture");
        const isHome = category.includes("home-decoration");
        const isLighting = category.includes("lighting");
