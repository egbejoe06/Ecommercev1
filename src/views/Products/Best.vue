<template>
  <div class="goods">
    ...
    <div class="subheader">
      ...
      <div class="sh1">
        <span class="sh11">Electronics</span>
  ...
  computed: {
    ...
    filteredProducts() {
      return this.products.filter((product) => {
        ...
        const ratingMatches = product.rating >= 4.5;
        const isPriceInRange =
          productPrice >= this.minValue && productPrice <= this.maxValue;
        return titleMatches && ratingMatches && isPriceInRange;
      });
    },
  },
