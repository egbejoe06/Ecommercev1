        ...
        <div class="smenu1">
          ...
          <div class="sm3">
            ...
            <div class="sm32">
              ...
              <div class="sm34">
                <span class="sm35" @click="selectCategory('womens-shoes')"
                  >Women Shoes</span
                >
                <span class="sm35" @click="selectCategory('mens-shoes')">Men Shoes</span>
                <span class="sm35" @click="selectCategory('womens-bag')">Women Bag</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="mm-1">
            <router-link :to="{ name: 'Productdetails', params: { id: product.id } }">
              <div>
                <img class="mm-img" :src="product.thumbnail" alt="" /></div
            ></router-link>
            <div class="mm1">
  ...
  computed: {
    ...
    filteredProducts() {
      return this.products.filter((product) => {
        ...
        const isWomensJewellery = category.includes("mens-shoes");
        ...
        if (
          ...
          return (
            ...
            productPrice >= this.minValue &&
            productPrice <= this.maxValue &&
            (isWomenShoes || isWomensBags || isWomensJewellery)
          );
        }
      });
    },
  ...
  methods: {
    ...
    calculateNormalPrice(discountPercentage, discountPrice) {
      if (typeof discountPercentage === "number" && discountPercentage !== 0) {
        const normalPrice = 1 - discountPercentage / 100;
