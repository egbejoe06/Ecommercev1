<template>
  <div class="goods">
    ...
    <div class="subheader">
      ...
      <div class="sh1">
        <span class="sh11">Cosmetics</span>
        ...
        <div class="smenu1">
          ...
          <div class="sm3">
            ...
            <div class="sm32">
              ...
              <div class="sm34">
                <span class="sm35" @click="selectCategory('fragrances')">Fragrances</span>
                <span class="sm35" @click="selectCategory('skincare')">Skin care</span>
              </div>
            </div>
          </div>
        </div>
